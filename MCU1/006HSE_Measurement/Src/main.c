...
int main(void)
{
	...
	*pRccCfgrReg |= (1 << 0);
	...
	//1. Config RCC Register to select HSI as clock source
		*pRccCfgrReg &= ~(0x3 << 21); // Clear 21st & 22nd Bit Pos
		*pRccCfgrReg |= (1 << 22); // Clear 21st & 22nd Bit Pos

		// Config MCO1 Prescaler
		*pRccCfgrReg |=  (1 << 26);
		*pRccCfgrReg |=  (1 << 25);
